...
/// Note: This matrix flips the y-axis so 0 is at the top.
pub fn new_projection3(width: f32, height: f32) -> na::Matrix3<f32> {
    return na::Matrix3::from_columns(&[
        na::Vector3::new(2.0 / width, 0.0, 0.0),
        na::Vector3::new(0.0, -2.0 / height, 0.0),
